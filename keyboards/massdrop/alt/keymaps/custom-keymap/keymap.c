...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    [0] = LAYOUT_65_ansi_blocker(
        ...
        LT(2, KC_ESC),  KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,  KC_VOLU, \
    ...
    [2] = LAYOUT_65_ansi_blocker(
        ...
        _______, _______, _______,    _______, _______, _______, _______, _______, _______, _______, _______,    RALT(KC_Y), _______, _______, _______, \
        _______, _______, RALT(KC_S), _______, _______, _______, _______, _______, _______, _______, RALT(KC_P), RALT(KC_Q),          _______, _______, \
